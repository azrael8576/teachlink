...
import com.wei.amazingtalker_recruit.feature.login.R as FeatureLoginR
...
internal open class WelcomeRobot(
    ...
    infix fun getStartedClick(func: LoginScreenRobot.() -> Unit): LoginScreenRobot {
        getStarted.performClick()
        return loginScreenRobot(composeTestRule) {
            // 等待任何動畫完成
