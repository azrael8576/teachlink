...
internal open class HomeScreenRobot(
    ...
    private val addUserString by composeTestRule.stringResource(R.string.add_user)
    private val menuString by composeTestRule.stringResource(R.string.menu)
    private val helloUserNameTextTag by composeTestRule.stringResource(R.string.tag_hello_user_name_text)
    private val myCoursesString by composeTestRule.stringResource(R.string.my_courses)
    private val chatsString by composeTestRule.stringResource(R.string.chats)
    private val tutorsString by composeTestRule.stringResource(R.string.tutors)
    private val courseProgressCardTag by composeTestRule.stringResource(R.string.tag_course_progress_card)
    private val pupilRatingCardTag by composeTestRule.stringResource(R.string.tag_pupil_rating_card)
    private val tutorButtonTag by composeTestRule.stringResource(R.string.tag_tutor_button)
    private val classNameTag by composeTestRule.stringResource(R.string.tag_class_name)
    private val classInfoTag by composeTestRule.stringResource(R.string.tag_class_info)
    private val contactCardString by composeTestRule.stringResource(R.string.contact_card)
    private val skillNameTag by composeTestRule.stringResource(R.string.tag_skill_name)
    private val skillLevelTag by composeTestRule.stringResource(R.string.tag_skill_level)
    private val circularProgressTag by composeTestRule.stringResource(R.string.tag_circular_progress)
    private val loadingContentTag by composeTestRule.stringResource(R.string.tag_loading_content)
    private val loadingErrorContentTag by composeTestRule.stringResource(R.string.tag_loading_error_content)
    private val screenNotAvailableString by composeTestRule.stringResource(R.string.screen_not_available)
