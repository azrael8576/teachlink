...
/**
 * Teach Link navigation bar item with icon and label content slots. Wraps Material 3
 * [NavigationBarItem].
 *
...
/**
 * Teach Link navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
...
/**
 * Teach Link navigation rail item with icon and label content slots. Wraps Material 3
 * [NavigationRailItem].
 *
 * @param modifier Modifier to be applied to this item.
 * @param selected Whether this item is selected.
...
/**
 * Teach Link navigation rail with header and content slots. Wraps Material 3 [NavigationRail].
 *
...
/**
 * Teach Link navigation drawer item with icon and label content slots. Wraps Material 3
...
/**
 * Teach Link navigation drawer with content slot. Wraps Material 3 [PermanentDrawerSheet].
 *
...
/**
 * Teach Link navigation default values.
 */
